...
def combine_judgelm_val_judge_samples(ans1_file_path, ans2_file_path, ansmore_file_paths, save_path):
    # load gt_file
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, required=True, 
                        default="/gaueko0/users/izubiaga/conanws/evaluation/JudgeLM-main/judgelm/data/judgelm-judge-samples.jsonl")
    args = parser.parse_args()

    combine_judgelm_val_judge_samples(args.ans1_file_path, args.ans2_file_path, args.ansmore_file_paths,args.save_path)
